  ...
  return (
    <div className="container">
      <div className="box">
        ...
        <div className="row input-group">
          ...
          <div className="col-5 d-flex flex-column ">
            ...
            <input
              ...
              placeholder="Description on the task"
            ></input>
          </div>
        ...
        <div className="row pt-2">
          <div className="col-12 ">
            <div className="btn-group">
              <button
                className={`btn btn2-c ${
                  iscomplateScreen === false && 'active'
                } `}
                type="button"
        ...
        <div
          className="todo-list overflow-scroll"
                ...
                <div className="justify-content-center " key={index}>
                  <div className="d-flex justify-content-between todo-list-item ">
                    ...
                    <div className="flex-2 icons align-self-center">
                      ...
                      ></i>
                      <i
                        class="fa-solid fa-check check-item"
                        onClick={() => handlecomplate(index)}
                      ></i>
                    </div>
                  </div>
                </div>
                ...
                <div className="justify-content-center " key={index}>
                  <div className="d-flex justify-content-between todo-list-item">
                    <div className="flex-1">
                      ...
                      <p>{item.description}</p>
                      <p>
                        <small>{item.completeTime}</small>
                      </p>
                    </div>
                    <div className="flex-2 icons align-self-center">
                      <i
                        class="fa-solid fa-trash delete"
                        onClick={() => deletecomplatebtn(index)}
                      ></i>
                    </div>
                  </div>
                </div>
